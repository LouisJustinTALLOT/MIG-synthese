...
Le procédé de traitement des eaux le plus répandu en France est le traitement actif par précipitation et coagulation-floculation-décantation (voir figure \ref{fig:bassin_decantation}). Il équipe onze des quinze stations de traitement des eaux de sortie de mine d'uranium françaises.
...
\begin{figure}[H]
    ...
    \end{minipage}\hfill
\end{figure}
%Les légendes s'arrangent mal. Qqun saurait corriger ça ?
