...
%Les élèves souhaitent tout particulièrement remercier leurs encadrants : Irina \textsc{Sin}, Sophie \textsc{Guillon}, Nicolas \textsc{Seigneur} et Vincent \textsc{Lagneau}. Merci pour votre implication tout au long du MIG !
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{I_B_3.jpg}
...
L’existence de dépôts d'uranium est connue en Australie depuis 1890, mais ce n’est qu’à partir de 1944 que commencent les recherches intenses de gisements d’uranium. Dans les années 1950, commença l’exploitation des mines de Rum Jungle, Mary Kathleen et South Alligator. A la fin des années 1970, trois autres mines sont mises en exploitation et de l'uranium est produit comme sous-produit dans deux autres mines à partir de 1988.
Cependant, entre 1984 et 2007, le gouvernement limite la produciton d'uranium à trois sites, puis en 2009, une quatrième mine est mise en exploitation, marquant le retour de l'expansion du marché de l'uranium en australie.
L’Australie est désormais le troisième producteur mondial d’uranium, et le premier pays en termes de ressources connues. Cependant, toute la production est exportée.
...
En 2011, les États-Unis ont extrait 9~\% de l'uranium consommé par leurs centrales nucléaires. Le reste était importé, principalement de Russie, du Kazakhstan, du Canada et d'Australie. Bien que la production d'uranium soit tombée à de faibles niveaux, les États-Unis possèdent la quatrième plus grande ressource d'uranium au monde, derrière l'Australie, le Canada et le Kazakhstan. Les États possédant les plus grandes réserves de minerai d'uranium sont le Wyoming, le Nouveau-Mexique et le Colorado.
...
Plusieurs méthodes de restauration sont introduites par Intercontinental Energy Corporation et les deux les plus courantes sont :
...
De même, la revégétalisation est souvent une étape nécessaire à la réhabilitation des sites de stockage de résidus.% cependant, dans certains pays, comme le Niger, le climat désertique ne permet pas d’assurer cette étape.
...
\paragraph{} L'annexe C \ref{annexe:sens_analytique} détaille à quel point les 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{I_A_2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{II_A2_4.png}
