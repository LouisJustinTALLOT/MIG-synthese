...
%\blue{est-ce que l'on répond à la quesiton?}
...
%     \label{fig:}
% \end{figure}
Nous nous intéressons à l'évolution de l'autunite, minéral de formule Ca(UO$_2$)$_2$(PO$_4$)$_2$ $\cdot$ 11 H$_2$O qui relâche des ions UO$_2^{2+}$ en solution quand solubilisé par les eaux de pluies qui s'infiltrent.
