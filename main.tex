...
Ces résultats sont à nuancer puisqu’à ce stade aucun modèle chimique n’a été intégré. De plus, certaines données non renseignées permettraient d’aller plus loin. Il serait ainsi possible de mieux renseigner la géométrie de la fosse à résidus : nous l’avons modélisé par un trapèze, mais il est très probable que les bords de la fosse soient constitués de gradins afin d’assurer la stabilité des parois. La prise en compte de la géométrie de ces gradins permettrait une modélisation plus précise du volume des résidus et donc du terme source des contaminants.
...
Rappelons que le modèle est peu contraint et que la marge d'incertitude reste forte. Des relevés et analyses chimiques plus complètes (analyse minéralogique et composition des solutions dans les piézomètres le long de la coupe en particulier) seront nécessaires pour mieux ajuster le modèle et renforcer ses capacités de prédiction.
...
%1
\paragraph{} L'après-mine répond à des besoins variés qui vont de la gestion des matériaux extraits du sol et de la surveillance des risques sanitaires à la reconversion écologique et économique du site. Effacer le passé minier d'un site est très difficile, d'autant plus que souvent, les acteurs opèrent sur des sites dont les caractéristiques pré-exploitation sont inconnues : à quel point faut-il réduire les taux d'uranium ? En effet, les sols en contiennent naturellement, et c'est justement parce qu'il était présent en quantité que l'exploitation a été mise en place. La question du fond géochimique est donc primordiale dans le secteur de l'après-mine.

%2
Notre étude de MIG nous a permis de tirer des conclusions sur la gestion technique du site de la Ribière. En matière de géochimie, nous avons utilisé une modélisation sur le logiciel HYTEC pour tester l'influence de différents paramètres sur les concentrations en éléments tels que l'uranium. Notre modèle, assez simple mais se basant sur des données géologiques du site, nous a permis ainsi de constater le rôle majeur du pH sur la mobilité de l'uranium, notamment au niveau de la sorption de celui-ci parfois remplacé par d'autres cations. HYTEC nous a aussi permis de modéliser le site de La Ribière en 2D et d'analyser les effets de divers paramètres sur le transport et les concentrations en uranium et autres \sout{oxydes} \red{métaux}, ainsi que la dispersion de ces éléments. %Le maillage du site et les éléments choisis ont toutefois pu parfois poser problème.
% pr le nombre de pages, je sais pas trop quelles sont les consignes générales, je pense qu'Irina et Sophie sont mieux placées que moi pour répondre à ça. Ah.. parce que sur la plaquette il doit y avoir ecrit qqch comme de 20 à 30 pages max, ce pour quoi on avait autant réduit

%NS: qques endroits où vous pouvez gagner de la place:
% fig 5-6-7: sur une ligne? 
% fig 8-9: ça peut se mettre en annexe, figure 12-15: peut être possible de condenser. 
% figure 16 et 19: peut peut être supprimer/annexe
% figure 20-23 : annexe (fig 24-25 montrent essentiellemlent la même même mais sont plus synthéthique)
% figre 27: vous pouvez enlever tous les z < 330 et z > 408 et gagner plusieurs cm
% figure 29 & 30: mettez les les unes en dessous des autres avec une seule colobar et une seule caption
% fig 31: mettez la cbar autrement et virez les parties grises, vous gagnerez aussi de la place
% fig 32 & 33: à combiner (une seule caption, une seule colobar, éventuellement côte à côte)
% fig 34-35: cote à cote
...
% Hydro : (difficultés?) et conclusion générale

Quant au risque radon, nous avons évalué que l'épaisseur de stériles était suffisamment grande pour respecter les valeurs de références dans des conditions habituelles. Comme un pic de concentration de radon dans l'air peut tout de même être atteint si le sol est très sec, le dérèglement du cycle de l'eau dû au changement climatique devra probablement induire des modifications des mesures mises en place sur le site de la Ribière, puisqu'il est prévu que les précipitations futures seront plus intenses, mais plus brèves et plus espacées dans le temps.

L'après-mine est un secteur partagé par de nombreux acteurs qui doivent collaborer. L'entreprise Orano, chargé de la gestion technique du site, doit viser les objectifs des PNGMDR successifs sous l'égide de l'ASN, et respecter les normes établies par l'IRSN. L'accord de tous les acteurs sur les normes n'est pas évident, puisque leurs intérêts sont tous différents : sécurité humaine, protection environnementale, gestion des matériaux, rentabilité économique ou revalorisation du paysage. C'est pour cela que l'IRSN développe une méthode multi-critères pour les normes à venir. Par ailleurs, fixer une norme n'est pas chose aisée : elle se base parfois sur des critères peu exhaustifs et plus ou moins arbitraires... Nous avons alors ici sur cet échantillon précis une image assez mitigée des normes et de leur construction - ce qui n'est bien évidemment pas représentatif car nous fondant sur un exemple précis.
...
$$ \frac{d\left[ Rn_{aq \quad ou \quad g} \right]}{dt}= K $$
...
\newpage
\section{Résultats des simulations numériques HYTEC}\label{annexe:modele-transport-reactive}
\begin{figure}[H]
    \centering
