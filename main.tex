...
\begin{figure}[!h]
    ...
    \caption{Taille des gisements d'uranium selon leur teneur et la quantité de minerai (Raimbault)}
...
\subsection{Les différents traitements}
...
\subsubsection{Comparaison et faisabilité}
