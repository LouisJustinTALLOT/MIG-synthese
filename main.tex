...
\begin{abstract}
France used to be a major mining country. Yet, the exploitation of most of French mines has been completely ended and the mining sites then need to be rehabilitated. That rehabilitation is the post-mine process. It aims at addressing environmental and health-related issues (such as the gestion of mining waste), as well as social (such as finding consensus with local associations and populations), political (for instance the accordance with standards) and economical issues.

This study deals with most of these questions. Its goal is to identify both the different parties the post-mine process involves and the issues it brings up, to try to solve them. It also deals with technical aspects of the process such as the treatment of polluted mining waste. We will focus on the former uranium mines, on the treatment of water and on the alleviation of radon. We will particularly study the former uranium mine La Ribière and the possibility of water treatment. After having synthesized these questions, we will draw a comparison of the diverse existing means of water treatment and investigate the strategies implemented by the major mining countries to deal with the post-mines problematics. 

We acknowledge that the major polluting substances (radon, radium, uranium…) can be efficiently treated. A hydrogeochemical modelisation of the La Ribière site will enable us to determine whether if the treatment of the effluents is necessary. The post-mine process is a serious issue which is often well dealt with by the exploiting firms but quite ignored by the local populations. Although many measures have been enforced, it is still necessary to inform the inhabitants of former mining areas to make bring the post-mine process into even wider attention. 
\end{abstract}
}
...
%coucou sophian:D super et toi oui hihihi c'est bientôt fini mais j'ai plein d'imges à rajouter encore
%Salut !!! ça va ? bien bien ! Enfin un peu de monde sur ce rapport xD
%ouai... haha bon courage ! Et t'as vu mon ptit comm pour les images des remerciements ? ok. Oui, mais si tu préfères l'ancienne forme, ça me dérange pas. Les deux sont bien. L'idéal serait d'avoir des remerciements plus personnalisés, mais c'est pas la priorité (pour les encadrants, j'ai mis un truc plus "perso" mais ça peut être amélioré aussi xD). Yep c'est pas le plus urgent. Y a toute la partie internationale à améliorer, les sources à ajouter (partie II) et puis tes images. On verra après xD
%nope je vais voir
% ah ça a été compacté les remerciements
% pour les encadrants c'est super ce que tu as fait
% après pour les autres bah c'est un peu compliqué
% je sais pas trop 
% j'approuve
% là je fais mes  images @ + :) :) enfin je suis là hein
% :)
...
Désormais géré par Orano Mining, le site de la Ribière est équipé d'appareils de mesure et de surveillance, notamment pour ce qui est de l’eau qui traverse le site. Ainsi, 4~points de surface \blue{ 4 points de quoi ? forage, puits de surveillance?} sont répartis sur les 14~hectares pour la surveillance environnementale tandis que 9~piézomètres permettent d’avoir une vision détaillée du profil géologique et hydrologique de l zone.

Selon Orano Mining, le site respecte les normes environnementales en vigueur en termes de qualité des eaux à l’exutoire (le ruisseau du Verraux). La concentration en uranium mesurée est de $7,6 \cdot 10^{-6}$~mol/L et la dose mesurée est de $1,37$~Bq/L pour le $^{226}$Ra. %Dernière phrase pas très claire
