...
Selon les mesures effectuées par Orano Mining \cite{chautard_evaluation_2020}, le site respecte les normes environnementales en vigueur en termes de qualité des eaux à l’exutoire (le ruisseau du Verraux). La concentration en uranium mesurée est de $7,6 \, . 10^{-6}$~mol/L et la dose mesurée est de $1,37$~Bq/L pour le $^{226}$Ra. En effet, les normes applicables sont de $1,7$~Bq/L pour le radium.
...
% Non : % si vous voulez mettre ce paragraphe à la fin 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{LJ-rate-Microcline-timestep0.png}
    \caption{Taux de dissolution de la microcline à l'état initial}
    \label{fig:rate_}
\end{figure}% je complie pour regarder des images . Je ferai des titres simples. fais autre chose
% c'est surtout que le premire couple d'images c'est au timestep = 0 - état inital 
% et le 2e au timestep = 1 - pluie forte . Ok . 
%donc comme saison pluies et sehce mais je sais pas si ça colle
% je sais pas quoi mettre pour les images :( :( help

% faudrait juste mettre une phrase pour introduire ces figures aussi .....
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{LJ-rate-Montmorillonite-timestep0.png}
    \caption{Taux de dissolution de la montmorillonite à l'état initial}
    \label{fig:rate_}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{LJ-rate-Microcline-timestep1.png}
    \caption{Taux de dissolution de la microcline sous régime de pluies fortes}
    \label{fig:rate_}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{LJ-rate-Montmorillonite-timestep1.png}
    \caption{Taux de dissolution de la montmorillonite sous régime de pluies fortes}
    \label{fig:rate_}
\end{figure}
\newpage
\listoffigures
