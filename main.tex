...
\begin{itemize}
    \item Irina Sin (Mines ParisTech - PSL, Centre de géosciences) 
    \item Sophie Guillon (Mines ParisTech - PSL, Centre de géosciences) 
    \item Nicolas Seigneur (Mines ParisTech - PSL, Centre de géosciences) 
    \item Vincent Lagneau (Mines ParisTech - PSL, Centre de géosciences) 
\end{itemize}
